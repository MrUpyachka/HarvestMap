...
Harvest.defaultSettings = {
	...
	compassLayouts = {
		[Harvest.BLACKSMITH]  = {texture = "HarvestMap/Textures/Compass/mining.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
		[Harvest.CLOTHING]    = {texture = "HarvestMap/Textures/Compass/clothing.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
		[Harvest.ENCHANTING]  = {texture = "HarvestMap/Textures/Compass/enchanting.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
		[Harvest.ALCHEMY]     = {texture = "HarvestMap/Textures/Compass/alchemy.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
		[Harvest.WOODWORKING] = {texture = "HarvestMap/Textures/Compass/wood.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
		[Harvest.CHESTS]      = {texture = "HarvestMap/Textures/Compass/chest.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
		[Harvest.WATER]       = {texture = "HarvestMap/Textures/Compass/solvent.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
		[Harvest.FISHING]     = {texture = "HarvestMap/Textures/Compass/fish.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
		[Harvest.HEAVYSACK]     = {texture = "HarvestMap/Textures/Compass/heavysack.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
		[Harvest.TROVE]      = {texture = "HarvestMap/Textures/Compass/trove.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
		[Harvest.OLDTROVE]      = {texture = "HarvestMap/Textures/Compass/trove.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
		[Harvest.JUSTICE]      = {texture = "HarvestMap/Textures/Compass/justice.dds", maxDistance = 0.004062019202318, color = {1, 1, 1}, additionalLayout = {Harvest.additionalLayout, Harvest.additionalLayoutReset} },
